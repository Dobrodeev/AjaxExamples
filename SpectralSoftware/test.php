...
define('API_KEY', '731fdb9f46272f54a8b68c894765410b');
// адрес запроса&mode=xml
//api.openweathermap.org/data/2.5/forecast/daily?q=London&mode=xml&units=metric&cnt=7
$url = "http://api.openweathermap.org/data/2.5/forecast/daily?q=Kiev&units=metric&cnt=5&lang=ua&apikey=API_KEY";
